...
# 自己定义的文件
from setting import *
from identify_captcha_picture import IdentifyCaptchaPicture
...
class Login(object):
    ...
    def download_captcha_picture():
        ...
        response = session.get(url, headers=headers)  # type: requests.Response
        if response.status_code == 200:
            captcha_picture = response.content  # type: bytes
